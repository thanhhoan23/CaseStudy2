        ...
        do {
            try {
                ...
                if (!(price > 1000)) {
                    ...
                    System.out.println("Giá tiền không được nhỏ hơn 10,000,000");
                    System.out.print("⟹ ");
                } else {
                    System.out.println("Đã nhập đúng");
                    check = true;
        ...
        do {
            try {
                ...
                if (quantity <= 0) {
                    ...
                    System.out.println("Số lượng không được lớn hơn 100.");
                    System.out.print("⟹ ");
                    check = false;
                } else {
    ...
    public static void editProduct() {
        ...
        do {
            try {
                ...
                System.out.print("⟹");
                long idProduct = Long.parseLong(input.nextLine().trim());
                ...
                if (productService.exitsById(idProduct)) {
                    ...
                    check = RetryUtils.isRetry(ChooseStatus.EDIT);
                } else {
                    System.out.println("Không tìm thấy ID sản phầm.");
                    RetryUtils.isRetry(ChooseStatus.EDIT);
//                    continueOrExistEdit();
                }
            } catch (Exception e) {
                System.out.println("Vui lòng nhập lại");
    ...
    public static void removeProduct() {
        ...
        do {
            try {
                ...
                check = RetryUtils.isRetry(ChooseStatus.FIND);
            } catch (Exception e) {
                System.out.println("Vui lòng nhập lại");
            }
        } while (check);
    ...
    public static void findProductByName() {
        ...
        String choice;
        if (products.size() != 0) {
//            System.out.println("Tên " + name + " có trong danh sách tìm kiếm");
            System.out.println("⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟹⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸⟸");
